    ...
    return (
        ...
        <div class="hero">
          <div class="hero-text-box">
            ...
            <a href="#cta" class="btn btn--full margin-right-sm">Bắt đầu trang web</a>

            <a href="#how" class="btn btn--outline">Tìm hiểu thêm &darr;</a>
          </div>
      ...
      <section class="section-how" id="how">
        <div class="container">
          <span class="subheading" style="font-size: x-large;">Giới thiệu</span>
      ...
      <section class="section-testimonials" id="testimonials">
        <div class="testimonials-container">
          <span class="subheading" style="font-size: x-large;">Thành viên</span>
        ...
        <div class="gallery">
          ...
          <figure class="gallery-item" style="margin-top: 4.5rem;">
            <img
              src="img/Logo.2c1a9feb9fa5e6fed63e (1).png"
              alt="Photo of beautifully
            arranged food"
            />
          </figure>
