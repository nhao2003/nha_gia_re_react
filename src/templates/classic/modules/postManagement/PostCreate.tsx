                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    {purposeTypes.map((option) => (
                        <Chip
                            key={option.value}
                            sx={{
                                backgroundColor: purposeType === option.value ? CUSTOM_COLOR.primary : '#CBD1DB',
                                color: purposeType === option.value ? '#CBD1DB' : CUSTOM_COLOR.primary,
                            }}
                            label={option.label}
                        ...
                        <div style={{ marginTop: '16px', display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                            {userTypes.map((option) => (
                                <Chip
                                    key={option.value}
                                    sx={{
                                        backgroundColor: userType === option.value ? CUSTOM_COLOR.primary : '#CBD1DB',
                                        color: userType === option.value ? '#CBD1DB' : CUSTOM_COLOR.primary,
                                    }}
                                    label={option.label}
                        ...
                        <Box>
                            <div>
                                ...
                                <Button
                                    ...
                                    sx={{ backgroundColor: CUSTOM_COLOR.primary , color: '#FFFFFF' }}
                                >
                                    Chọn ảnh
                                </Button>
                            </div>
