import { FormControl, Grid, IconButton, InputAdornment, OutlinedInput, Stack, Typography, useMediaQuery, useTheme } from '@mui/material'
      ...
      >
        ...
        >
          ...
          >
            ...
            >Bất động sản theo địa điểm</Typography>
        ...
        >
          ...
          >
            ...
            >Bất động sản đăng bán</Typography>
            <Stack direction={'row'} spacing={1}
              alignItems={'center'}
              sx={{
                color: CUSTOM_COLOR.primary
          ...
          >
            {
              Array.from(Array(6)).slice(0, endSlice).map((_, index) => (
                <HomeCard
                  key={index}
        ...
        >
          ...
          >
            ...
            >Bất động sản cho thuê</Typography>
            <Stack direction={'row'} spacing={1}
              alignItems={'center'}
              sx={{
                color: CUSTOM_COLOR.primary
